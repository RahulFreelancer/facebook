...
const DetailForm = ({showForm,arg1,arg2,arg3,placeholder}) => {
...
changeForm(data);
    ...
    <form className={styles.workForm}>
        ...
        <textarea type='textarea' name={arg3}
         onChange={handleFormChange} value={form[arg3]} 
         className={`${styles.textInput} ${styles.detailTextarea}`} 
       ...
       <div className={styles.saveAndCanelButtonBox}>
        ...
        <button disabled={form.detailString?false:true}
        onClick={saveForm} 
